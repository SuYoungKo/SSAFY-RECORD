...
const setTime = () => {
  ...
  if (date.getMinutes() < 10 && date.getSeconds() < 10)
    timer.textContent = `${date.getHours()}:0${date.getMinutes()}:0${date.getSeconds()}`;
  else if (date.getMinutes() < 10)
    timer.textContent = `${date.getHours()}:0${date.getMinutes()}:${date.getSeconds()}`;
  else if (date.getSeconds() < 10)
    timer.textContent = `${date.getHours()}:${date.getMinutes()}:0${date.getSeconds()}`;
  else
